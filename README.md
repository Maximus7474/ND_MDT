...
This resource is created for [ND_Core](https://forum.cfx.re/t/wip-nd-core/4792200?u=andyyy7666) and is also compatible with [ESX v1.9.1 or newer](https://github.com/esx-framework/esx_core) but I might integrate it with QB in the future if there's any interest.
